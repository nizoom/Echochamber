...
app.use(express.static(path.join("/Users/nissimram/Desktop/Enter-the-Echo-Chamber/", 'client/build')));
// --------------------------------
...
app.get('*', (req, res) => {
    res.sendFile(path.resolve("/Users/nissimram/Desktop/Enter-the-Echo-Chamber/", '/client/build', 'index.html'));
});
